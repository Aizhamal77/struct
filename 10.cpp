...
public:
    ...
    void input() {
        ...
        if (minutes < 0 || minutes >= 60) {
            cout << "Ошибка! Минуты должны быть в диапазоне от 0 до 59." << endl;
            minutes = 0.0;
        }
    }
...
public:
    ...
    void input() {
        cout << "\nКорабль #" << shipNumber << endl;
        cout << "Введите данные о широте: ";
        latitude.input();
        cout << "Введите данные о долготе: ";
        longitude.input();
    }

    void display() const {
        cout << "Корабль #" << shipNumber << endl;
        cout << "Широта: ";
        latitude.display();
        cout << "\nДолгота: ";
        longitude.display();
